...
@extends('template.main', ['menu' => "admin", 'submenu' => "Alterar Material"])
<!-- Preenche o conteúdo da seção "titulo" -->
@section('titulo') Material @endsection
<!-- Preenche o conteúdo da seção "conteudo" -->
@section('conteudo')

<form action="{{ route('material.update', $dados['id']) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col" >
